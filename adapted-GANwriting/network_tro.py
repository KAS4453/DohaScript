...
# At ep1440: dis<gen>=5.35, cla<gen>=6.29 — generator overwhelmed on both fronts.
# Reduce dis weight so gen can make progress; boost rec so legibility is prioritised.
w_dis = 0.5   # was 1.0; halved so gen isn't purely chasing an already-dominant dis
w_cla = 1.0   # unchanged
w_l1  = 0.0   # unchanged (OOV mode)
w_rec = 2.0   # was 1.0; doubled — rec loss directly measures legibility
